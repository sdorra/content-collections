  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-10 gap-6">
      ...
      <FeatureCard title="Simple to use">
        No need to manually fetch and parse your content anymore. Just import it
        and start using Content Collections. It provides a simple API, allowing
        you to concentrate on building your app.
      </FeatureCard>
      ...
      <FeatureCard title="Support" comingSoon>
        Content Collection includes a range of adapters that support popular web
        frameworks. It also provides a CLI tool for use in environments without
        native support.
      </FeatureCard>
    </section>
  );
