...
- Install the package:
  ...
  <PackageInstall
    ...
    packages={["@content-collections/markdown"]}
  />
...
- Use the generated html in your application.
  ...
  {/* TODO use tabs for the examples */}
...
- `allowDangerousHtml` (optional): A boolean to allow dangerous HTML. The default value is `false`.
